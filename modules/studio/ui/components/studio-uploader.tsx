...
export const StudioUploader = ({ endpoint, onSuccess }: StudioUploaderProps) => {
	return (
		<div>
			<MuxUploader endpoint={endpoint} id={UPLOADER_ID} onSuccess={onSuccess} className="hidden group/uploader" />
			{/* <MuxUploader endpoint={endpoint} className="hidden group/uploader" /> */}
